...
- Shell snippets that users append to their own dotfiles (e.g. `scripts/claude-tmux-aliases.sh`) live in `scripts/`. They are documentation-shaped — comments on top describing install + usage — not standalone executables.
